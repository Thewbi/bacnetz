...
public class DefaultDevice implements Device {
    ...
    public Message getPropertyValue(final Message requestMessage, final int propertyIdentifierCode) {
        ...
        if (deviceProperty != null) {
            ...
            return messageFactory.create(deviceProperty.getMessageType(), this, requestMessage.getApdu().getInvokeId(),
                    deviceProperty.getPropertyKey(), deviceProperty.getValue());
...
//		LOG.info(Utils.byteArrayToStringNoPrefix(bytes));
    ...
    private Message processObjectListProperty(final int propertyIdentifierCode, final Message requestMessage) {
